...
#include "unitree_legged_msgs/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCmd__ros_msg_type = unitree_legged_msgs__msg__MotorCmd;
...
static uint32_t _MotorCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_legged_msgs__msg__MotorCmd(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_legged_msgs__msg__MotorCmd;
    is_plain =
      (
...
static size_t _MotorCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_legged_msgs__msg__MotorCmd(

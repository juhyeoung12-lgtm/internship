...
#include "unitree_legged_msgs/msg/detail/motor_cmd__functions.h"  // motor_cmd
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_legged_msgs__msg__LowCmd;
    is_plain =
      (
...
static size_t _LowCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_legged_msgs__msg__LowCmd(

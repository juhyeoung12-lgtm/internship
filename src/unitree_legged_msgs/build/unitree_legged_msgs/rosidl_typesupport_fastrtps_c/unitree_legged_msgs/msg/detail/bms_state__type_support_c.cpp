...
#include "unitree_legged_msgs/msg/detail/bms_state__rosidl_typesupport_fastrtps_c.h"
...
using _BmsState__ros_msg_type = unitree_legged_msgs__msg__BmsState;
...
static uint32_t _BmsState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_legged_msgs__msg__BmsState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_legged_msgs__msg__BmsState;
    is_plain =
      (
...
static size_t _BmsState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_legged_msgs__msg__BmsState(

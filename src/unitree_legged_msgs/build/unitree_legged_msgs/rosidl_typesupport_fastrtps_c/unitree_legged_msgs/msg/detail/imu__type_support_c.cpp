...
#include "unitree_legged_msgs/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
using _IMU__ros_msg_type = unitree_legged_msgs__msg__IMU;
...
static uint32_t _IMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_legged_msgs__msg__IMU(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_legged_msgs__msg__IMU;
    is_plain =
      (
...
static size_t _IMU__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_legged_msgs__msg__IMU(

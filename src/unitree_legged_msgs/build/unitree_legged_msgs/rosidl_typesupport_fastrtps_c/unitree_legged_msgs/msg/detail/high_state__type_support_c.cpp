...
#include "unitree_legged_msgs/msg/detail/cartesian__functions.h"  // foot_position2_body, foot_speed2_body
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_unitree_legged_msgs
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: foot_position2_body
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    size_t size = 4;
    auto array_ptr = ros_message->foot_position2_body;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
      {
  ...
  // Field name: foot_speed2_body
  {
    ...
    size_t size = 4;
    auto array_ptr = ros_message->foot_speed2_body;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
      {

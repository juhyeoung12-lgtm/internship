  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: foot_position2_body
  {
    for (size_t i = 0; i < 4; i++) {
      unitree_legged_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.foot_position2_body[i],
        cdr);
    }
  }
  // Member: foot_speed2_body
  {
    for (size_t i = 0; i < 4; i++) {
      unitree_legged_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.foot_speed2_body[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: foot_position2_body
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        unitree_legged_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.foot_position2_body[index], current_alignment);
    }
  }
  // Member: foot_speed2_body
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        unitree_legged_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.foot_speed2_body[index], current_alignment);
    }
  }
  // Member: wireless_remote
  {

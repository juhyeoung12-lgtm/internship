...
#include "unitree_legged_msgs/msg/detail/bms_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const unitree_legged_msgs::msg::BmsCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unitree_legged_msgs::msg::BmsCmd & ros_message)
{
  // Member: off
  cdr >> ros_message.off;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_legged_msgs::msg::BmsCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unitree_legged_msgs::msg::BmsCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_legged_msgs::msg::BmsCmd *>(
    untyped_ros_message);
...
{
  return &unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_BmsCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_legged_msgs, msg, BmsCmd)() {
  return &unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_BmsCmd__handle;
}

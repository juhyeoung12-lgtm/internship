...
#include "unitree_legged_msgs/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_legged_msgs::msg::MotorCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unitree_legged_msgs::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_legged_msgs::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  return &unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}

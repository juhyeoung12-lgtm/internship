...
size_t unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__size_function__HighCmd__wireless_remote(
  const void * untyped_member)
{
  (void)untyped_member;
  return 40;
...
const void * unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__get_const_function__HighCmd__wireless_remote(
  const void * untyped_member, size_t index)
{
  const uint8_t * member =
    (const uint8_t *)(untyped_member);
...
void * unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__get_function__HighCmd__wireless_remote(
  void * untyped_member, size_t index)
{
  uint8_t * member =
    (uint8_t *)(untyped_member);
...
void unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__fetch_function__HighCmd__wireless_remote(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const uint8_t * item =
    ((const uint8_t *)
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__get_const_function__HighCmd__wireless_remote(untyped_member, index));
  uint8_t * value =
    (uint8_t *)(untyped_value);
  *value = *item;
}

void unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__assign_function__HighCmd__wireless_remote(
  void * untyped_member, size_t index, const void * untyped_value)
{
  uint8_t * item =
    ((uint8_t *)
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__get_function__HighCmd__wireless_remote(untyped_member, index));
  const uint8_t * value =
    (const uint8_t *)(untyped_value);
  *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__HighCmd_message_member_array[20] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs__msg__HighCmd, gait_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs__msg__HighCmd, speed_level),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs__msg__HighCmd, foot_raise_height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs__msg__HighCmd, body_height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs__msg__HighCmd, yaw_speed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    40,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs__msg__HighCmd, wireless_remote),  // bytes offset in struct
    NULL,  // default value
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__size_function__HighCmd__wireless_remote,  // size() function pointer
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__get_const_function__HighCmd__wireless_remote,  // get_const(index) function pointer
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__get_function__HighCmd__wireless_remote,  // get(index) function pointer
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__fetch_function__HighCmd__wireless_remote,  // fetch(index, &value) function pointer
    unitree_legged_msgs__msg__HighCmd__rosidl_typesupport_introspection_c__assign_function__HighCmd__wireless_remote,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
    "reserve",  // name

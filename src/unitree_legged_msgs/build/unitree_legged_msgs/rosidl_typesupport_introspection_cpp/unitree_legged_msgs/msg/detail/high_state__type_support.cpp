...
size_t size_function__HighState__foot_position2_body(const void * untyped_member)
{
  (void)untyped_member;
  return 4;
}

const void * get_const_function__HighState__foot_position2_body(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__HighState__foot_position2_body(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__HighState__foot_position2_body(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const unitree_legged_msgs::msg::Cartesian *>(
    get_const_function__HighState__foot_position2_body(untyped_member, index));
  auto & value = *reinterpret_cast<unitree_legged_msgs::msg::Cartesian *>(untyped_value);
  value = item;
}

void assign_function__HighState__foot_position2_body(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<unitree_legged_msgs::msg::Cartesian *>(
    get_function__HighState__foot_position2_body(untyped_member, index));
  const auto & value = *reinterpret_cast<const unitree_legged_msgs::msg::Cartesian *>(untyped_value);
  item = value;
}

size_t size_function__HighState__foot_speed2_body(const void * untyped_member)
{
  (void)untyped_member;
  return 4;
}

const void * get_const_function__HighState__foot_speed2_body(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::array<unitree_legged_msgs::msg::Cartesian, 4> *>(untyped_member);
  return &member[index];
...
void * get_function__HighState__foot_speed2_body(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::array<unitree_legged_msgs::msg::Cartesian, 4> *>(untyped_member);
  return &member[index];
...
void fetch_function__HighState__foot_speed2_body(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const unitree_legged_msgs::msg::Cartesian *>(
    get_const_function__HighState__foot_speed2_body(untyped_member, index));
  auto & value = *reinterpret_cast<unitree_legged_msgs::msg::Cartesian *>(untyped_value);
  value = item;
}

void assign_function__HighState__foot_speed2_body(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<unitree_legged_msgs::msg::Cartesian *>(
    get_function__HighState__foot_speed2_body(untyped_member, index));
  const auto & value = *reinterpret_cast<const unitree_legged_msgs::msg::Cartesian *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HighState_message_member_array[26] = {
  {
    "stamp",  // name
    ...
    offsetof(unitree_legged_msgs::msg::HighState, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    20,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, motor_state),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, foot_force),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, foot_force_est),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, gait_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, foot_raise_height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, body_height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, yaw_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, range_obstacle),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, foot_position2_body),  // bytes offset in struct
    nullptr,  // default value
    size_function__HighState__foot_position2_body,  // size() function pointer
    get_const_function__HighState__foot_position2_body,  // get_const(index) function pointer
    get_function__HighState__foot_position2_body,  // get(index) function pointer
    fetch_function__HighState__foot_position2_body,  // fetch(index, &value) function pointer
    assign_function__HighState__foot_position2_body,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, foot_speed2_body),  // bytes offset in struct
    nullptr,  // default value
    size_function__HighState__foot_speed2_body,  // size() function pointer
    get_const_function__HighState__foot_speed2_body,  // get_const(index) function pointer
    get_function__HighState__foot_speed2_body,  // get(index) function pointer
    fetch_function__HighState__foot_speed2_body,  // fetch(index, &value) function pointer
    assign_function__HighState__foot_speed2_body,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    40,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::HighState, wireless_remote),  // bytes offset in struct
    nullptr,  // default value

...
{
  new (message_memory) unitree_legged_msgs::msg::IMU(_init);
}

void IMU_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_legged_msgs::msg::IMU *>(message_memory);
  typed_message->~IMU();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMU_message_member_array[5] = {
  {
    ...
    offsetof(unitree_legged_msgs::msg::IMU, quaternion),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::IMU, gyroscope),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::IMU, accelerometer),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::IMU, rpy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::IMU, temperature),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMU_message_members = {
  ...
  "IMU",  // message name
  5,  // number of fields
  sizeof(unitree_legged_msgs::msg::IMU),
...
{
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::IMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_legged_msgs, msg, IMU)() {
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::IMU_message_type_support_handle;
}

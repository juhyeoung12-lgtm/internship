...
{
  new (message_memory) unitree_legged_msgs::msg::LED(_init);
}

void LED_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_legged_msgs::msg::LED *>(message_memory);
  typed_message->~LED();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LED_message_member_array[3] = {
  {
    ...
    offsetof(unitree_legged_msgs::msg::LED, r),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::LED, g),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::LED, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LED_message_members = {
  ...
  "LED",  // message name
  3,  // number of fields
  sizeof(unitree_legged_msgs::msg::LED),
...
{
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::LED_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_legged_msgs, msg, LED)() {
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::LED_message_type_support_handle;
}

...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LowCmd_message_member_array[11] = {
  ...
  },
  {
    ...
    20,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::LowCmd, motor_cmd),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    40,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::LowCmd, wireless_remote),  // bytes offset in struct
    nullptr,  // default value

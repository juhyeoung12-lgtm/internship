...
{
  new (message_memory) unitree_legged_msgs::msg::Cartesian(_init);
}

void Cartesian_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_legged_msgs::msg::Cartesian *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Cartesian_message_member_array[3] = {
  {
    ...
    offsetof(unitree_legged_msgs::msg::Cartesian, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::Cartesian, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::Cartesian, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Cartesian_message_members = {
  ...
  3,  // number of fields
  sizeof(unitree_legged_msgs::msg::Cartesian),
...
get_message_type_support_handle<unitree_legged_msgs::msg::Cartesian>()
{
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::Cartesian_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_legged_msgs, msg, Cartesian)() {
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::Cartesian_message_type_support_handle;
}

...
{
  new (message_memory) unitree_legged_msgs::msg::MotorCmd(_init);
}

void MotorCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_legged_msgs::msg::MotorCmd *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCmd_message_member_array[7] = {
  {
    ...
    offsetof(unitree_legged_msgs::msg::MotorCmd, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::MotorCmd, q),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::MotorCmd, dq),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::MotorCmd, tau),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::MotorCmd, kp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::MotorCmd, kd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_legged_msgs::msg::MotorCmd, reserve),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCmd_message_members = {
  ...
  7,  // number of fields
  sizeof(unitree_legged_msgs::msg::MotorCmd),
...
{
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_legged_msgs, msg, MotorCmd)() {
  return &::unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCmd_message_type_support_handle;
}

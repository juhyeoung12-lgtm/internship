...
#ifndef UNITREE_LEGGED_MSGS__MSG__DETAIL__IMU__TRAITS_HPP_
#define UNITREE_LEGGED_MSGS__MSG__DETAIL__IMU__TRAITS_HPP_
...
inline void to_yaml(
  const unitree_legged_msgs::msg::IMU & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const unitree_legged_msgs::msg::IMU & msg)
{
  return unitree_legged_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<unitree_legged_msgs::msg::IMU>()
{
  return "unitree_legged_msgs::msg::IMU";
}

template<>
inline const char * name<unitree_legged_msgs::msg::IMU>()
{
  return "unitree_legged_msgs/msg/IMU";
}

template<>
struct has_fixed_size<unitree_legged_msgs::msg::IMU>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<unitree_legged_msgs::msg::IMU>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<unitree_legged_msgs::msg::IMU>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // UNITREE_LEGGED_MSGS__MSG__DETAIL__IMU__TRAITS_HPP_

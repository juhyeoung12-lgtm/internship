...
#ifndef UNITREE_LEGGED_MSGS__MSG__DETAIL__IMU__STRUCT_HPP_
#define UNITREE_LEGGED_MSGS__MSG__DETAIL__IMU__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__unitree_legged_msgs__msg__IMU __attribute__((deprecated))
#else
# define DEPRECATED__unitree_legged_msgs__msg__IMU __declspec(deprecated)
#endif
...
struct IMU_
{
  ...
  using ConstRawPtr =
    const unitree_legged_msgs::msg::IMU_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      unitree_legged_msgs::msg::IMU_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__unitree_legged_msgs__msg__IMU
    std::shared_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__unitree_legged_msgs__msg__IMU
    std::shared_ptr<unitree_legged_msgs::msg::IMU_<ContainerAllocator> const>
...
using IMU =
  unitree_legged_msgs::msg::IMU_<std::allocator<void>>;
...
#endif  // UNITREE_LEGGED_MSGS__MSG__DETAIL__IMU__STRUCT_HPP_

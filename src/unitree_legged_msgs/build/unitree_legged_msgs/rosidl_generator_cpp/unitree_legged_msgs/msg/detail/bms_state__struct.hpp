...
#ifndef UNITREE_LEGGED_MSGS__MSG__DETAIL__BMS_STATE__STRUCT_HPP_
#define UNITREE_LEGGED_MSGS__MSG__DETAIL__BMS_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__unitree_legged_msgs__msg__BmsState __attribute__((deprecated))
#else
# define DEPRECATED__unitree_legged_msgs__msg__BmsState __declspec(deprecated)
#endif
...
struct BmsState_
{
  ...
  using ConstRawPtr =
    const unitree_legged_msgs::msg::BmsState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      unitree_legged_msgs::msg::BmsState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__unitree_legged_msgs__msg__BmsState
    std::shared_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__unitree_legged_msgs__msg__BmsState
    std::shared_ptr<unitree_legged_msgs::msg::BmsState_<ContainerAllocator> const>
...
using BmsState =
  unitree_legged_msgs::msg::BmsState_<std::allocator<void>>;
...
#endif  // UNITREE_LEGGED_MSGS__MSG__DETAIL__BMS_STATE__STRUCT_HPP_

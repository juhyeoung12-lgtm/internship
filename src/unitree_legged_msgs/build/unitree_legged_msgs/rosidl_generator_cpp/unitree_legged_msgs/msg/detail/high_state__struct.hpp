...
struct HighState_
{
    ...
    bms(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->foot_position2_body.fill(unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>{_init});
      this->foot_speed2_body.fill(unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>{_init});
  ...
  : stamp(_alloc, _init),
    ...
    foot_position2_body(_alloc),
    foot_speed2_body(_alloc),
    wireless_remote(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->yaw_speed = 0.0f;
      std::fill<typename std::array<float, 4>::iterator, float>(this->range_obstacle.begin(), this->range_obstacle.end(), 0.0f);
      this->foot_position2_body.fill(unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>{_alloc, _init});
      this->foot_speed2_body.fill(unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>{_alloc, _init});
      std::fill<typename std::array<uint8_t, 40>::iterator, uint8_t>(this->wireless_remote.begin(), this->wireless_remote.end(), 0);
      this->reserve = 0ul;
      this->crc = 0ul;
    }
  ...
  using _foot_position2_body_type =
    std::array<unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>, 4>;
  _foot_position2_body_type foot_position2_body;
  using _foot_speed2_body_type =
    std::array<unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>, 4>;
  _foot_speed2_body_type foot_speed2_body;
  ...
  Type & set__foot_position2_body(
    const std::array<unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>, 4> & _arg)
  {
    this->foot_position2_body = _arg;
    return *this;
  }
  Type & set__foot_speed2_body(
    const std::array<unitree_legged_msgs::msg::Cartesian_<ContainerAllocator>, 4> & _arg)
  {
    this->foot_speed2_body = _arg;
    return *this;
  }
  ...
  bool operator==(const HighState_ & other) const
  {
    ...
    if (this->foot_position2_body != other.foot_position2_body) {
      return false;
    }
    if (this->foot_speed2_body != other.foot_speed2_body) {
      return false;
    }

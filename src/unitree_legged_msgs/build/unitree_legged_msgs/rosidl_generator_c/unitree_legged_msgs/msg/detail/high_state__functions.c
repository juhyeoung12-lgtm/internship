...
unitree_legged_msgs__msg__HighState__init(unitree_legged_msgs__msg__HighState * msg)
{
  ...
  for (size_t i = 0; i < 4; ++i) {
    if (!unitree_legged_msgs__msg__Cartesian__init(&msg->foot_position2_body[i])) {
      unitree_legged_msgs__msg__HighState__fini(msg);
      return false;
    }
  }
  // foot_speed2_body
  for (size_t i = 0; i < 4; ++i) {
    if (!unitree_legged_msgs__msg__Cartesian__init(&msg->foot_speed2_body[i])) {
      unitree_legged_msgs__msg__HighState__fini(msg);
      return false;
    }
  }
...
unitree_legged_msgs__msg__HighState__fini(unitree_legged_msgs__msg__HighState * msg)
{
  ...
  // foot_position2_body
  for (size_t i = 0; i < 4; ++i) {
    unitree_legged_msgs__msg__Cartesian__fini(&msg->foot_position2_body[i]);
  }
  // foot_speed2_body
  for (size_t i = 0; i < 4; ++i) {
    unitree_legged_msgs__msg__Cartesian__fini(&msg->foot_speed2_body[i]);
  }
  // wireless_remote
  // reserve
  // crc
...
unitree_legged_msgs__msg__HighState__are_equal(const unitree_legged_msgs__msg__HighState * lhs, const unitree_legged_msgs__msg__HighState * rhs)
{
  ...
  for (size_t i = 0; i < 4; ++i) {
    if (!unitree_legged_msgs__msg__Cartesian__are_equal(
        &(lhs->foot_position2_body[i]), &(rhs->foot_position2_body[i])))
    {
      return false;
    }
  }
  ...
  for (size_t i = 0; i < 4; ++i) {
    if (!unitree_legged_msgs__msg__Cartesian__are_equal(
        &(lhs->foot_speed2_body[i]), &(rhs->foot_speed2_body[i])))
    {
      return false;
    }
  }
  ...
  unitree_legged_msgs__msg__HighState * output)
{
  ...
  for (size_t i = 0; i < 4; ++i) {
    if (!unitree_legged_msgs__msg__Cartesian__copy(
        &(input->foot_position2_body[i]), &(output->foot_position2_body[i])))
    {
      return false;
    }
  }
  ...
  for (size_t i = 0; i < 4; ++i) {
    if (!unitree_legged_msgs__msg__Cartesian__copy(
        &(input->foot_speed2_body[i]), &(output->foot_speed2_body[i])))
    {
      return false;
    }
  }

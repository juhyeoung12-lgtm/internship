...
bool
unitree_legged_msgs__msg__MotorCmd__are_equal(const unitree_legged_msgs__msg__MotorCmd * lhs, const unitree_legged_msgs__msg__MotorCmd * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
unitree_legged_msgs__msg__MotorCmd__copy(
  const unitree_legged_msgs__msg__MotorCmd * input,
  unitree_legged_msgs__msg__MotorCmd * output)
{
  if (!input || !output) {
    return false;
  }
...
unitree_legged_msgs__msg__MotorCmd__create()
{
  ...
  unitree_legged_msgs__msg__MotorCmd * msg = (unitree_legged_msgs__msg__MotorCmd *)allocator.allocate(sizeof(unitree_legged_msgs__msg__MotorCmd), allocator.state);
  if (!msg) {
    return NULL;
  }
...
unitree_legged_msgs__msg__MotorCmd__Sequence__init(unitree_legged_msgs__msg__MotorCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (unitree_legged_msgs__msg__MotorCmd *)allocator.zero_allocate(size, sizeof(unitree_legged_msgs__msg__MotorCmd), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unitree_legged_msgs__msg__MotorCmd__Sequence * array = (unitree_legged_msgs__msg__MotorCmd__Sequence *)allocator.allocate(sizeof(unitree_legged_msgs__msg__MotorCmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
unitree_legged_msgs__msg__MotorCmd__Sequence__are_equal(const unitree_legged_msgs__msg__MotorCmd__Sequence * lhs, const unitree_legged_msgs__msg__MotorCmd__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!unitree_legged_msgs__msg__MotorCmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
unitree_legged_msgs__msg__MotorCmd__Sequence__copy(
  const unitree_legged_msgs__msg__MotorCmd__Sequence * input,
  unitree_legged_msgs__msg__MotorCmd__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(unitree_legged_msgs__msg__MotorCmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    unitree_legged_msgs__msg__MotorCmd * data =
      (unitree_legged_msgs__msg__MotorCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!unitree_legged_msgs__msg__MotorCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          unitree_legged_msgs__msg__MotorCmd__fini(&output->data[i]);
        }
        return false;
      }
    }

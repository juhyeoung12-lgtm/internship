...
static const _Cartesian_type_support_symbol_names_t _Cartesian_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_legged_msgs, msg, Cartesian)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_legged_msgs, msg, Cartesian)),
  }
};
...
{
  return &::unitree_legged_msgs::msg::rosidl_typesupport_cpp::Cartesian_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unitree_legged_msgs, msg, Cartesian)() {
  return get_message_type_support_handle<unitree_legged_msgs::msg::Cartesian>();
}

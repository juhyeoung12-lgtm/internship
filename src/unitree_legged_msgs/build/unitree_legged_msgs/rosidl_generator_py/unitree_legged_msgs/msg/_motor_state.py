...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.tauest = kwargs.get('tauest', float())
    ...
    @builtins.property
    def tauest(self):
        """Message field 'tauest'."""
        return self._tauest

    @tauest.setter
    def tauest(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'tauest' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'tauest' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._tauest = value

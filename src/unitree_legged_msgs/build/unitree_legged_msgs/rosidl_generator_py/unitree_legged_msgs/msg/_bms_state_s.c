...
bool unitree_legged_msgs__msg__bms_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_legged_msgs.msg._bms_state.BmsState", full_classname_dest, 43) == 0);
  }
  unitree_legged_msgs__msg__BmsState * ros_message = _ros_message;
  {  // version_h
...
PyObject * unitree_legged_msgs__msg__bms_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_legged_msgs.msg._bms_state");

...
bool unitree_legged_msgs__msg__bms_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_legged_msgs.msg._bms_cmd.BmsCmd", full_classname_dest, 39) == 0);
  }
  unitree_legged_msgs__msg__BmsCmd * ros_message = _ros_message;
  {  // off
...
PyObject * unitree_legged_msgs__msg__bms_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_legged_msgs.msg._bms_cmd");

...
bool unitree_legged_msgs__msg__high_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // motor_state
    ...
    Py_ssize_t size = 20;
    unitree_legged_msgs__msg__MotorState * dest = ros_message->motor_state;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // foot_position2_body
    PyObject * field = PyObject_GetAttrString(_pymsg, "foot_position2_body");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'foot_position2_body'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    Py_ssize_t size = 4;
    unitree_legged_msgs__msg__Cartesian * dest = ros_message->foot_position2_body;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // foot_speed2_body
    PyObject * field = PyObject_GetAttrString(_pymsg, "foot_speed2_body");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'foot_speed2_body'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    Py_ssize_t size = 4;
    unitree_legged_msgs__msg__Cartesian * dest = ros_message->foot_speed2_body;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!unitree_legged_msgs__msg__cartesian__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
PyObject * unitree_legged_msgs__msg__high_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // foot_position2_body
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->foot_position2_body[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "foot_position2_body", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // foot_speed2_body
    ...
    unitree_legged_msgs__msg__Cartesian * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->foot_speed2_body[i]);
      PyObject * pyitem = unitree_legged_msgs__msg__cartesian__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "foot_speed2_body", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }

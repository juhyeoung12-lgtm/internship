...
class LowState(metaclass=Metaclass_LowState):
    ...
    _fields_and_field_types = {
        ...
        'reserve': 'uint32',
        'crc': 'uint32',
        'ee_force_raw': 'unitree_legged_msgs/Cartesian[4]',
        'ee_force': 'unitree_legged_msgs/Cartesian[4]',
    ...
    def __init__(self, **kwargs):
        ...
        from unitree_legged_msgs.msg import Cartesian
        self.ee_force_raw = kwargs.get(
            'ee_force_raw',
            [Cartesian() for x in range(4)]
        )
        from unitree_legged_msgs.msg import Cartesian
        self.ee_force = kwargs.get(
            'ee_force',
            [Cartesian() for x in range(4)]
        )
        from unitree_legged_msgs.msg import Cartesian
    ...
    def __eq__(self, other):
        ...
        if self.crc != other.crc:
            return False
        if self.ee_force_raw != other.ee_force_raw:
            return False
        if self.ee_force != other.ee_force:
            return False
    ...
    @builtins.property
    def ee_force_raw(self):
        """Message field 'ee_force_raw'."""
        return self._ee_force_raw

    @ee_force_raw.setter
    def ee_force_raw(self, value):
        if __debug__:
            from unitree_legged_msgs.msg import Cartesian
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'ee_force_raw' field must be a set or sequence with length 4 and each value of type 'Cartesian'"
        self._ee_force_raw = value

    @builtins.property
    def ee_force(self):
        """Message field 'ee_force'."""
        return self._ee_force

    @ee_force.setter
    def ee_force(self, value):
        if __debug__:
            from unitree_legged_msgs.msg import Cartesian
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Cartesian) for v in value) and
                 True), \
                "The 'ee_force' field must be a set or sequence with length 4 and each value of type 'Cartesian'"
        self._ee_force = value

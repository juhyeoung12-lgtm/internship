...
class HighState(metaclass=Metaclass_HighState):
    ...
    _fields_and_field_types = {
        ...
        'motor_state': 'unitree_legged_msgs/MotorState[20]',
        ...
        'foot_position2_body': 'unitree_legged_msgs/Cartesian[4]',
        'foot_speed2_body': 'unitree_legged_msgs/Cartesian[4]',
    ...
    def __init__(self, **kwargs):
        ...
        from unitree_legged_msgs.msg import Cartesian
        self.foot_position2_body = kwargs.get(
            'foot_position2_body',
            [Cartesian() for x in range(4)]
        )
        from unitree_legged_msgs.msg import Cartesian
        self.foot_speed2_body = kwargs.get(
            'foot_speed2_body',
            [Cartesian() for x in range(4)]
        )
    ...
    def __eq__(self, other):
        ...
        if any(self.range_obstacle != other.range_obstacle):
            return False
        if self.foot_position2_body != other.foot_position2_body:
            return False
        if self.foot_speed2_body != other.foot_speed2_body:
            return False
    ...
    @builtins.property
    def foot_position2_body(self):
        """Message field 'foot_position2_body'."""
        return self._foot_position2_body

    @foot_position2_body.setter
    def foot_position2_body(self, value):
        if __debug__:
            from unitree_legged_msgs.msg import Cartesian
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'foot_position2_body' field must be a set or sequence with length 4 and each value of type 'Cartesian'"
        self._foot_position2_body = value

    @builtins.property
    def foot_speed2_body(self):
        """Message field 'foot_speed2_body'."""
        return self._foot_speed2_body

    @foot_speed2_body.setter
    def foot_speed2_body(self, value):
        if __debug__:
            from unitree_legged_msgs.msg import Cartesian
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Cartesian) for v in value) and
                 True), \
                "The 'foot_speed2_body' field must be a set or sequence with length 4 and each value of type 'Cartesian'"
        self._foot_speed2_body = value
